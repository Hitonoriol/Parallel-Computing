#ifndef LAB1_TASK1_HPP_
#define LAB1_TASK1_HPP_
...
class Task1: public Task
{
	private:
		...
		/* Load and analyze `chars.txt`. Called by a separate pthread. */
		static void* process_chars(void*);

		/* Load and analyze `nums.txt`. Called by a separate pthread. */
		static void* process_nums(void*);
